...
const TEMPLATES: JobTemplate[] = [
  ...
  //   description: 'Fine-tune a base LLM using LoRA adapters on your custom dataset.',
  //   category: 'training',
  //   jobType: 'training',
  //   estimatedMinutes: 30,
  //   rateHalalaPerMin: 25,
  //   model: 'mistralai/Mistral-7B-v0.1',
  //   params: { dataset: 'your_dataset.jsonl', epochs: 3, lora_r: 16, lora_alpha: 32, learning_rate: 0.0002, batch_size: 4 },
  //   tags: ['Training', 'LoRA', 'Fine-tune'],
  //   vramGb: 24, tier: 'Cached', estimatedLoadTimeSeconds: 15,
  // },
  {
    id: 'vllm-serve',
    name: 'vLLM Serving',
