...
// v2 agent-first product + explainer page (/v2/agents).
//
          ...
          <div className="ag-grid-2">
            ...
            <div>
              ...
              <pre className="ag-code">
                ...
                {'\n  '}
                <span className="k">{'"topup_url"'}</span>: <span className="s">{'"https://dcp.sa/v2/renter/wallet"'}</span>,
                {'\n  '}
