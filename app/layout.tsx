...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <head>
        {/* perf: preconnect to Google Fonts hosts so the render-blocking
            stylesheet + woff2 fetches start their TCP/TLS handshake during
            HTML parse (saves ~80-150ms on first paint). */}
