...
const copy = {
  ...
  roleSub: 'ابدأ من المسار المناسب لدورك. DCP يحافظ على نفس ركائز الثقة: حوسبة سيادية مستضافة داخل المملكة، دعم النماذج العربية من الدرجة الأولى، وواجهة متوافقة مع OpenAI.',
  roleCards: [
    {
      title: 'أنا مستأجر',
