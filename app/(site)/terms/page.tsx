...
export default function TermsPage() {
  return (
    <LegalShell title="Terms of Service" lastUpdated="July 26, 2026">
      ...
      <p>Renter usage of the inference API is billed in Saudi halala (1/100 SAR) per million tokens at the published per-model rate. The current rate card by model class is maintained at <a href="https://dcp.sa/pricing">dcp.sa/pricing</a>; rates may change with at least 30 days&apos; prior notice for active subscribers. Renters may pay-as-you-go from a prepaid balance, or subscribe to a monthly tier that grants a SAR credit allotment plus a uniform percentage discount on every model&apos;s per-token rate. Pay-as-you-go top-up balance does not expire. Subscription monthly credit not consumed by the end of the billing period rolls over for thirty (30) days, then expires. GPU rental, where offered, is billed per GPU-second. Provider compensation is determined by a published revenue-share schedule and is paid in halala. Disputes regarding usage metering must be raised within thirty (30) days of the disputed charge via <a href="mailto:billing@dcp.sa">billing@dcp.sa</a>.</p>

      <p><strong>Auto top-up authorization.</strong> If you enable saved-card auto top-up, you authorize DC Power Solutions Company to charge your saved Moyasar payment token when your available DCP credit falls below the threshold you configure. Each automatic charge is limited to the top-up amount and monthly cap shown in the in-app auto top-up settings at the time you save them. You may disable auto top-up or remove the saved card at any time; removing the saved card also disables auto top-up. Auto top-ups create prepaid DCP account credit after successful payment confirmation. If an auto top-up fails, is declined, requires additional authentication, or reaches your monthly cap, DCP may pause or reject chargeable jobs until you add credit manually.</p>

      <p><strong>Value Added Tax (VAT).</strong> All published rates are exclusive of Value Added Tax (VAT). If and when DC Power Solutions Company becomes VAT-registered under the laws of the Kingdom of Saudi Arabia, VAT will be applied at the statutory rate (currently 15%) and shown as a separate line item on your invoice.</p>

      <p><strong>Refunds, cancellation, and payment disputes.</strong> Inference tokens, GPU time, storage, and other compute already consumed are non-refundable once the service has been performed and delivered. You may request a refund of unused paid credit by contacting <a href="mailto:billing@dcp.sa">billing@dcp.sa</a> or, where available, by submitting a refund request from the payments console with the payment reference and reason. Refund requests are reviewed by an administrator and may be approved or rejected based on payment status, unused balance, consumed usage, suspected fraud, chargeback activity, and the applicable order form. Eligible approved refunds are returned to the original payment method through Moyasar when supported; otherwise DCP may record an internal balance adjustment. Billing, metering, auto top-up, or refund disputes must be raised within thirty (30) days of the relevant payment or charge. This policy does not limit any non-waivable rights you may have under applicable law.</p>
