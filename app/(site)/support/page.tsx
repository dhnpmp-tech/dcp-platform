...
import { intentSupportCategory, persistRoleIntent, readRoleIntent, RoleIntent, trackRoleIntentApplied } from '@/app/lib/role-intent'
...
function SupportPageInner() {
  ...
  return (
    <SiteShell active="/support">
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12" dir={isRTL ? 'rtl' : 'ltr'}>
