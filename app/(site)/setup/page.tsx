...
export default function SetupPage() {
  ...
  const topAction =
    keyStatus === 'ready' ? (
      <Link href="/renter/dashboard" className="skip">
        <Bi en="Open console →" ar="افتح الكونسول →" />
      </Link>
    ) : keyStatus === 'loading' ? null : (
      <Link href="/auth?role=renter&new&redirect=/setup" className="skip">
    ...
    <div className="setup">
      ...
      <div className="card" data-pane={3} style={{ display: step === 3 ? 'block' : 'none' }}>
        ...
        {keyStatus === 'missing' && (
          <div className="callout err">
            ...
            />{' '}
            <Link href="/auth?role=renter&new&redirect=/setup">
        ...
        {keyStatus === 'error' && (
          <div className="callout err">
            {keyError}{' '}
            <Link href="/auth?role=renter&method=apikey&redirect=/setup">
      ...
      <div className="card" data-pane={4} style={{ display: step === 4 ? 'block' : 'none' }}>
        ...
        <div className="nav-row">
          ...
          <Link className="btn-pri" href="/renter/dashboard">
