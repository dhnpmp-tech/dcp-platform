...
// v2 marketing home.
// dcp-kit.css is imported by app/(site)/layout.tsx; only the co-located page CSS is
    ...
    <div style={{ background: 'var(--bg)', color: 'var(--ink)', minHeight: '100vh', fontFamily: 'var(--sans)' }}>
      ...
      <div className={menuOpen ? 'v2-mobile-menu on' : 'v2-mobile-menu'} id="mobile-menu">
        ...
        <div className="mm-body" onClick={(e) => {
          ...
          <Link className="mm-link" href="/docs">
          ...
          <div className="home-hero-grid">
            <div>
              ...
              <div className="door-grid">
                ...
                <Link className="door" href="/provider-setup">
      ...
      <section className="hiw">
        <div className="wrap">
          ...
          {/* Sovereignty boundary — the round-trip never crosses the border.
              ...
              pipeline). The plumbing lives on /architecture. */}
          <div className="sov">
          ...
          <p className="hiw-foot">
            {lang === 'ar' ? (
              <>
                ...
                <Link href="/architecture"><Bi en="See the full architecture →" ar="اطّلع على البنية الكاملة ←" /></Link>
              </>
            ) : (
              <>
      ...
      <section id="marketplace">
        <div className="wrap">
            ...
            return (
              ...
              <span>
                <Bi en="Prefer the whole card? RTX-class · 24 GB · dedicated — rent it by the minute, in SAR" ar="تفضّل البطاقة كاملة؟ فئة RTX · ٢٤ جيجابايت · مخصصة — استأجرها بالدقيقة، بالريال" />
                  ...
                  <Link href="/containers"><Bi en="Launch a pod →" ar="شغّل حاوية ←" /></Link>
                </div>
              </div>
            )
          })()}
          ...
          <div className="mp-live-head" style={{ border: 0, padding: '0 0 12px' }}>
            <span><Bi en="Rent one of these GPUs — spin up your own pod" ar="استأجر أحد هذه المعالجات — وشغّل وحدتك الخاصة" /></span>
            <Link href="/renter/pods"><Bi en="Open the launch console →" ar="افتح وحدة الإطلاق ←" /></Link>
          </div>
          ...
          <div className="capacity-truth" style={{ marginBottom: 24 }}>
            <div className="capacity-copy">
              ...
              <div style={{ marginTop: 22, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                <Link className="btn" href="/renter/pods">
                  <Bi en="Launch a pod →" ar="شغّل حاوية ←" />
                </Link>
                <Link className="btn ghost" href="/containers">
...
# → settled in halala against your wallet at end of stream`}</span>
        ...
        <div className="wrap">
          ...
          <div className="qs-wrap">
            <div className="qs-left">
              ...
              <div style={{ marginTop: 30, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                <Link className="btn primary lg" href="/agents">
                  <Bi en="The agent playbook →" ar="دليل الوكلاء ←" />
                </Link>
                <Link className="btn ghost" href="/docs#agents">
          ...
          <div className="paths">
            ...
            <div className="path">
              ...
              <div className="cta">
                ...
                <Link className="btn ghost" href="/provider/dashboard">
          ...
          <div style={{ marginTop: 40 }}>
            ...
            <p style={{ marginTop: 14, color: 'var(--ink-2)', fontSize: 14, lineHeight: 1.6 }}>
              <Bi
                ...
                ar="كل حاوية هي معالج NVIDIA كامل ومخصص مع صلاحيات الجذر وJupyter عبر TLS وSSH خلال دقيقة تقريباً — يُخدَّم من عتاد سعودي متحقق داخل المملكة (متوافق مع نظام حماية البيانات). يمكنك تشغيل حاويتين في آنٍ واحد، وكل حاوية عند الطلب تعمل على معالج مخصص خاص بها — دون مشاركة بين حاوياتك. الأنواع عند الطلب (H200 وH100 وA100 وL40S وRTX 5090 وRTX 4090) مُسعّرة بالتكلفة زائد هامش من السوق الحي، فكل سعر هو حدٌّ أدنى «من» يتغير مع السعر الأصلي؛ أما RTX 3090 المحلي فهو بطاقة مجتمعية سعودية، وأجهزة Apple Silicon (من فئة M2) متاحة لأحمال الاستدلال فقط. أرقام الدولار تقديرية وفق ربط ساما (١ دولار ≈ ٣٫٧٥ ريال)؛ والفوترة بالريال السعودي."
              />
            </p>
          </div>
      ...
      {/* ═══════════════ FAQ ═══════════════ */}
      {/* Visible Q&A mirroring the FAQPage JSON-LD in app/(site)/(home)/layout.tsx.
      ...
      <section className="home-end">
        <div className="wrap">
          ...
          <div className="ctas">
            ...
            <Link className="btn ghost lg" href="/provider-setup">
