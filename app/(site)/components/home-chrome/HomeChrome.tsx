...
export function HomeChrome() {
  ...
  const menuLinks: ReadonlyArray<{ href: string; n: string; tEn: string; tAr: string; sEn: string; sAr: string }> = [
    ...
    { href: '/agents', n: '06', tEn: 'Agents', tAr: 'الوكلاء', sEn: 'Live at agents.dcp.sa · MCP', sAr: 'على agents.dcp.sa · MCP' },
    { href: '/pricing', n: '07', tEn: 'Pricing', tAr: 'الأسعار', sEn: 'Per-second · per-token · SAR', sAr: 'بالثانية · بالرمز · بالريال' },
    { href: '/docs', n: '08', tEn: 'Docs', tAr: 'التوثيق', sEn: 'API · CLI · SDKs', sAr: 'واجهة · سطر أوامر · مكتبات' },
    { href: '/trust-center', n: '09', tEn: 'Trust center', tAr: 'مركز الثقة', sEn: 'PDPL · compliance · enterprise', sAr: 'نظام البيانات · امتثال · مؤسسات' },
    { href: '/provider-setup', n: '10', tEn: 'Earn', tAr: 'اكسب', sEn: 'Register a GPU · paid in SAR', sAr: 'سجّل معالجاً · يُدفع بالريال' },
    { href: '/', n: '11', tEn: 'Overview', tAr: 'نظرة عامة', sEn: 'Sovereign Arabic AI runtime', sAr: 'بيئة تشغيل عربية سيادية' },
  ]
