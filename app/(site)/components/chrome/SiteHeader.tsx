...
const NAV: ReadonlyArray<{ href: string; en: string; ar: string }> = [
  ...
  { href: '/benchmarks', en: 'Benchmarks', ar: 'القياسات' },
...
const MENU: ReadonlyArray<{ href: string; n: string; tEn: string; tAr: string; sEn: string; sAr: string }> = [
  ...
  { href: '/models', n: '03', tEn: 'Models', tAr: 'النماذج', sEn: 'Provider-backed model rows', sAr: 'صفوف نماذج مدعومة بمزوّد' },
  { href: '/marketplace', n: '04', tEn: 'Marketplace', tAr: 'السوق', sEn: 'Live GPU and model capacity', sAr: 'سعة GPU ونماذج حية' },
  { href: '/fine-tuning', n: '05', tEn: 'Fine-Tuning', tAr: 'الضبط الدقيق', sEn: 'LoRA contracts · proof-gated serving', sAr: 'عقود LoRA · خدمة مقيدة بالإثبات' },
  { href: '/batch', n: '06', tEn: 'Batch', tAr: 'الدُفعات', sEn: 'JSONL validation · execution gated', sAr: 'تحقق JSONL · التشغيل مقيد' },
  { href: '/dedicated-deployments', n: '07', tEn: 'Deployments', tAr: 'النشر', sEn: 'Endpoint proof · traffic gated', sAr: 'إثبات النقطة · الحركة مقيدة' },
  { href: '/benchmarks', n: '08', tEn: 'Benchmarks', tAr: 'القياسات', sEn: 'Measured rows · quality claims gated', sAr: 'صفوف مقاسة · ادعاءات الجودة مقيدة' },
  { href: '/pricing', n: '09', tEn: 'Pricing', tAr: 'الأسعار', sEn: 'Per-million-token · SAR', sAr: 'لكل مليون رمز · بالريال' },
  { href: '/pods', n: '10', tEn: 'GPU Pods', tAr: 'حاويات GPU', sEn: 'Rent a whole GPU on demand', sAr: 'استأجر معالجاً كاملاً عند الطلب' },
  { href: '/agents', n: '11', tEn: 'Agents', tAr: 'الوكلاء', sEn: 'Zero-human onboarding · MCP', sAr: 'تهيئة بلا بشر · MCP' },
  { href: '/providers', n: '12', tEn: 'Providers', tAr: 'المزوّدون', sEn: 'Aggregate supply, private by design', sAr: 'عرض مجمع وخصوصي التصميم' },
  { href: '/docs', n: '13', tEn: 'Docs', tAr: 'التوثيق', sEn: 'OpenAI-compatible API', sAr: 'واجهة متوافقة مع OpenAI' },
  { href: '/provider-setup', n: '14', tEn: 'Earn', tAr: 'اكسب', sEn: 'Earn Riyal from your GPU', sAr: 'اكسب ريالاً من معالجك' },
  { href: '/support', n: '15', tEn: 'Support', tAr: 'الدعم', sEn: 'Talk to the team', sAr: 'تواصل مع الفريق' },
]
