...
const MENU: ReadonlyArray<{ href: string; n: string; tEn: string; tAr: string; sEn: string; sAr: string }> = [
  ...
  { href: '/dedicated-deployments', n: '05', tEn: 'Deployments', tAr: 'النشر', sEn: 'Endpoint proof · traffic gated', sAr: 'إثبات النقطة · الحركة مقيدة' },
  { href: '/benchmarks', n: '06', tEn: 'Benchmarks', tAr: 'القياسات', sEn: 'Measured rows · quality claims gated', sAr: 'صفوف مقاسة · ادعاءات الجودة مقيدة' },
  { href: '/pricing', n: '07', tEn: 'Pricing', tAr: 'الأسعار', sEn: 'Per-million-token · SAR', sAr: 'لكل مليون رمز · بالريال' },
  { href: '/pods', n: '08', tEn: 'GPU Pods', tAr: 'حاويات GPU', sEn: 'Rent a whole GPU on demand', sAr: 'استأجر معالجاً كاملاً عند الطلب' },
  { href: '/agents', n: '09', tEn: 'Agents', tAr: 'الوكلاء', sEn: 'Zero-human onboarding · MCP', sAr: 'تهيئة بلا بشر · MCP' },
  { href: '/docs', n: '10', tEn: 'Docs', tAr: 'التوثيق', sEn: 'OpenAI-compatible API', sAr: 'واجهة متوافقة مع OpenAI' },
  { href: '/provider-setup', n: '11', tEn: 'Earn', tAr: 'اكسب', sEn: 'Earn Riyal from your GPU', sAr: 'اكسب ريالاً من معالجك' },
  { href: '/support', n: '12', tEn: 'Support', tAr: 'الدعم', sEn: 'Talk to the team', sAr: 'تواصل مع الفريق' },
]
