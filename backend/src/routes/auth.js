  ...
  try {
    ...
    return res.json({
      ...
      renter: {
        ...
        use_case: effectiveRenterRow.use_case || null,
        phone: effectiveRenterRow.phone || null,
        legal_entity_name: effectiveRenterRow.legal_entity_name || null,
        commercial_registration_number: effectiveRenterRow.commercial_registration_number || null,
        billing_address: effectiveRenterRow.billing_address || null,
        vat_number: effectiveRenterRow.vat_number || null,
        expected_monthly_volume: effectiveRenterRow.expected_monthly_volume || null,
