...
function buildEvaluatorJobSchema(now = new Date()) {
  return {
    ...
    next_actions: [
      'Create migrations and tests for metadata-only eval job records.',
      'Add idempotent renter-scoped create/list/read routes with worker disabled.',
