...
const LIVE_ACCEPTANCE_GATES = Object.freeze([
  ...
  },
  {
    ...
    next_action: 'Promote an opt-in live prompt-cache settlement proof before enabling discounts.',
  },
  {
    ...
    next_action: 'Promote an opt-in live batch execution proof after result storage and discount policy are ready.',
  },
  {
    ...
    next_action: 'Promote a gated live LoRA artifact proof after provider-host training execution is ready.',
  },
  {
